<template>
  <div
    ...
    v-if="depth === 1 && !filterRules.children?.length"
  >
    <p>暂无规则</p>
  </div>
  <div v-else class="rulers-select-wraper">
        ...
        <div class="select-label-row">
          ...
          >
            ...
            <div class="icon-list">
              ...
              <el-icon class="i-icon" @click="removeRuleItem(item)">
                <RemoveFilled />
              </el-icon>
            </div>
          </div>
    ...
    <div class="add-item">
      <span class="horizontal-line"></span>
      <el-icon class="i-icon" @click="insertRuleItem(null)">
        <CirclePlusFilled />
      </el-icon>
    </div>
...
import { reactive, toRefs, nextTick, watch, ref, type PropType } from "vue";
import type { ElForm } from "element-plus";
import type { Rule } from "../types";

const treeForm = ref<null | InstanceType<typeof ElForm>>(null);
